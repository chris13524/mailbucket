...
<div class="container" style="margin-top:1rem;">
	...
	<p>Well, if you use a simple address like <code>mytest@mailbucket.io</code>, then yes, anybody can read the email you're sending. But don't do that, make up a random address like <code>Y1IhwHzkdnY3z8@mailbucket.io</code> and use that. Additionally, I suggest generating this address on-the-fly rather than hard coding it.
	</p>
